#!/usr/bin/env python3
"""
Solution Restoration -- Lab 01: Transit Prevention Policy
...
# Depth: scripts/fault-injection -> scripts -> lab-01 -> bgp-dual-ce -> labs/
...
def main() -> int:
    ...
    print("=" * 60)
    print("Solution Restoration: Lab 01 Transit Prevention")
    print("=" * 60)
