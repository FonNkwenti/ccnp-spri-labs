#!/usr/bin/env python3
"""
Lab Setup — Transit Prevention Policy (bgp-dual-ce/lab-01)

Pushes initial configs (lab-00 solution state: eBGP + iBGP + customer prefix
origination already in place) to all four lab devices. Students configure the
transit-prevention prefix-list/route-map themselves during the lab.
...
DEFAULT_LAB_PATH = "ccnp-spri/bgp-dual-ce/lab-01-transit-prevention.unl"
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: Transit Prevention Policy (EVE-NG: {host})")
    if args.reset:
