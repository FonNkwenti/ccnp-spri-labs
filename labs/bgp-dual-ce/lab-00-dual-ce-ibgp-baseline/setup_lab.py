#!/usr/bin/env python3
"""
Lab Setup — Dual-CE iBGP Architecture and Baseline (bgp-dual-ce/lab-00)

Pushes initial configs (interfaces + IP addressing only) to all four lab devices.
Students configure BGP themselves during the lab.
...
DEFAULT_LAB_PATH = "ccnp-spri/bgp-dual-ce/lab-00-dual-ce-ibgp-baseline.unl"
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: Dual-CE iBGP Baseline (EVE-NG: {host})")
    if args.reset:
