...
PREFLIGHT_FAULT_MARKER = "neighbor 10.0.0.2 next-hop-self __FAULT_INJECTED__"
# If this string is absent -> not in solution state, bail out.
PREFLIGHT_SOLUTION_MARKER = "neighbor 10.0.0.2 next-hop-self"

POST_INJECT_COMMANDS = ["clear ip bgp 10.0.0.2 soft out"]
