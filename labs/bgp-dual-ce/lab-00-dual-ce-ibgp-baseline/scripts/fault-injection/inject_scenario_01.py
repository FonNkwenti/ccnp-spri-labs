...
FAULT_COMMANDS = [
    "router bgp 65001",
    "no neighbor 10.0.0.2 update-source Loopback0",
]
...
PREFLIGHT_FAULT_MARKER = "neighbor 10.0.0.2 update-source __FAULT_INJECTED__"
# If this string is absent -> not in solution state, bail out.
PREFLIGHT_SOLUTION_MARKER = "neighbor 10.0.0.2 update-source Loopback0"

POST_INJECT_COMMANDS = ["clear ip bgp 10.0.0.2"]
...
def main() -> int:
    ...
    try:
        ...
        conn.save_config()
        print("[*] Forcing BGP session re-evaluation ...")
