#!/usr/bin/env python3
"""
Lab Setup -- Inbound Traffic Engineering Across Two ISPs (bgp-dual-ce/lab-02)

Pushes initial configs (lab-01 solution state for R1-R4 plus the new R5/R6
baseline interfaces) to all six lab devices. Students configure the iBGP
sessions, next-hop-self, BGP origination on R5/R6, and the AS-path prepend
on R2 themselves during the lab.

Usage:
    python3 setup_lab.py --host <eve-ng-ip>
    python3 setup_lab.py --host <eve-ng-ip> --node R5,R6
...
DEFAULT_LAB_PATH = "ccnp-spri/bgp-dual-ce/lab-02-inbound-traffic-engineering.unl"
...
def main() -> int:
    ...
    parser.add_argument("--node", default=None,
                        help="Comma-separated device names (e.g., R5,R6)")
    ...
    print("=" * 60)
    print(f"Lab Setup: Inbound Traffic Engineering (EVE-NG: {host})")
    if args.reset:
