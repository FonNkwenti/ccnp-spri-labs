...
FAULT_COMMANDS = [
    "router bgp 65001",
    "address-family ipv4",
    "no neighbor 10.1.13.2 route-map LOCAL_PREF_FROM_R3 in",
    "neighbor 10.1.13.2 route-map LOCAL_PREF_FROM_R3 out",
    "exit-address-family",
]

PREFLIGHT_CMD = "show running-config | section router bgp"
PREFLIGHT_SOLUTION_MARKER = "neighbor 10.1.13.2 route-map LOCAL_PREF_FROM_R3 in"
