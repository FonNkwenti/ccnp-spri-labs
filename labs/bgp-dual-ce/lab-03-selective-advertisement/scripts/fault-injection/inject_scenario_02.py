...
DEVICE_NAME = "R3"
FAULT_COMMANDS = [
    "ip prefix-list ONLY_AGGREGATE seq 5 permit 192.168.1.0/24",
    "router bgp 65100",
    "address-family ipv4",
    "neighbor 10.0.0.5 prefix-list ONLY_AGGREGATE out",
    "exit-address-family",
]
...
POST_INJECT_COMMANDS = ["clear ip bgp 10.0.0.5 soft out"]
