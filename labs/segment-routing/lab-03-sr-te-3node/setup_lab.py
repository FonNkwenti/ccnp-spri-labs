#!/usr/bin/env python3
"""
Lab Setup — SR-TE Policies, Constraints, and Automated Steering (Lab 03, 3-Node Variant)
...
DEFAULT_LAB_PATH = "ccnp-spri/segment-routing/lab-03-sr-te-3node.unl"

# R1, R3, R4 are IOS-XRv 9000 (SR-TE core). CE1/CE2 are IOSv (customer edge).
DEVICES = {
    "R1": "cisco_xr_telnet",
    "R3": "cisco_xr_telnet",
    "R4": "cisco_xr_telnet",
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: SR-TE Policies Lab 03 (3-Node Variant) — EVE-NG: {host}")
    print("=" * 60)
