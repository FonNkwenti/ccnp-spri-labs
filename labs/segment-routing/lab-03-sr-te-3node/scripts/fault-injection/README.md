# Fault Injection — Segment Routing Lab 03 (3-Node Variant)
...
```bash
python3 apply_solution.py --host <eve-ng-ip>         # establish solution state
python3 inject_scenario_01.py --host <eve-ng-ip>     # Ticket 1
python3 apply_solution.py --host <eve-ng-ip>         # restore
python3 inject_scenario_02.py --host <eve-ng-ip>     # Ticket 2
python3 apply_solution.py --host <eve-ng-ip>         # restore
python3 inject_scenario_03.py --host <eve-ng-ip>     # Ticket 3
python3 apply_solution.py --host <eve-ng-ip>         # restore
