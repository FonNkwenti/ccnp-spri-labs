# Fault Injection — Segment Routing Lab 04
...
```bash
python3 setup_lab.py --host <eve-ng-ip>                              # reset to base config
python3 apply_solution.py --host <eve-ng-ip>                         # bring lab to solution state
python3 inject_scenario_01.py --host <eve-ng-ip>                     # inject Ticket 1
# ... troubleshoot using only show commands ...
python3 apply_solution.py --host <eve-ng-ip>                         # restore before next ticket
python3 inject_scenario_02.py --host <eve-ng-ip>                     # inject Ticket 2
# ... troubleshoot ...
python3 apply_solution.py --host <eve-ng-ip>
python3 inject_scenario_03.py --host <eve-ng-ip>                     # inject Ticket 3
# ... troubleshoot ...
python3 apply_solution.py --host <eve-ng-ip>
```
