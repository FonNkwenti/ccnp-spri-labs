#!/usr/bin/env python3
"""
Lab Setup — Topology-Independent Loop-Free Alternate (TI-LFA) (Segment Routing Lab 01)
...
# Depth: lab-01-ti-lfa/ -> segment-routing/ -> labs/
...
DEFAULT_LAB_PATH = "ccnp-spri/segment-routing/lab-01-ti-lfa.unl"
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: TI-LFA (EVE-NG: {host})")
