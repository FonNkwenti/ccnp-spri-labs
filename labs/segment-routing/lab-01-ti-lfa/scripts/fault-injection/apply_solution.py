#!/usr/bin/env python3
"""
Solution Restoration -- TI-LFA Lab (lab-01-ti-lfa)
...
All devices (R1, R2) are IOS-XRv 9000 and use the cisco_xr_telnet driver.
...
def main() -> int:
    ...
    parser.add_argument("--reset", action="store_true",
                        help="Soft-reset before restoring: default all interfaces and remove "
                             "routing protocols")
