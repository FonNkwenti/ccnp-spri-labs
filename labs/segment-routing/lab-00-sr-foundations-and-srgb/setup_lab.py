#!/usr/bin/env python3
"""
Lab Setup — SR-MPLS Foundations, SRGB, and Prefix SIDs (Segment Routing Lab 00)
...
# Depth: lab-00-sr-foundations-and-srgb/ -> segment-routing/ -> labs/
...
DEFAULT_LAB_PATH = "ccnp-spri/segment-routing/lab-00-sr-foundations-and-srgb.unl"
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: SR-MPLS Foundations, SRGB, and Prefix SIDs (EVE-NG: {host})")
