...
# Present only after the fault is already injected — area 1 in OSPF config.
PREFLIGHT_FAULT_MARKER = "area 1"

XR_USERNAME = "fon"
XR_PASSWORD = "cisco123"
# Present in the known-good solution config — area 0 with all interfaces.
PREFLIGHT_SOLUTION_MARKER = "area 0"
