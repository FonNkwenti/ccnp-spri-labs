...
FAULT_COMMANDS = [
    "segment-routing",
    "global-block 16000 16003",
    "commit",
]

# Pre-flight: verify the lab is in known-good state before injecting.
PREFLIGHT_CMD = "show running-config segment-routing"
# Present only after the fault is already injected — shrunken SRGB.
PREFLIGHT_FAULT_MARKER = "global-block 16000 16003"

XR_USERNAME = "fon"
XR_PASSWORD = "cisco123"
# Present in the known-good solution config — full SRGB range.
PREFLIGHT_SOLUTION_MARKER = "global-block 16000 23999"
