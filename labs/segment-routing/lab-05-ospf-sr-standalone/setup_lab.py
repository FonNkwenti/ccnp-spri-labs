#!/usr/bin/env python3
"""
Lab Setup — OSPF Segment Routing Extensions (Standalone) (Segment Routing Lab 05)
...
# Depth: lab-05-ospf-sr-standalone/ -> segment-routing/ -> labs/
...
DEFAULT_LAB_PATH = "ccnp-spri/segment-routing/lab-05-ospf-sr-standalone.unl"
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: OSPF SR Standalone (EVE-NG: {host})")
