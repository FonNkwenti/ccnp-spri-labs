...
FAULT_COMMANDS = [
    "segment-routing",
    " global-block 16000 16049",
    "commit",
]

# Pre-flight: read running config on segment-routing to verify full SRGB range
# is present before injecting the shrunk range.
PREFLIGHT_CMD = "show running-config segment-routing"
# If this string is already present → fault already injected, bail out.
PREFLIGHT_FAULT_MARKER = "global-block 16000 16049"
