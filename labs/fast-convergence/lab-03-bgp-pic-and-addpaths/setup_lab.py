#!/usr/bin/env python3
"""
Lab Setup — BGP PIC Edge/Core and Additional Paths (Fast Convergence Lab 03)
...
# Depth: lab-03-bgp-pic-and-addpaths/ -> fast-convergence/ -> labs/
...
DEFAULT_LAB_PATH = "ccnp-spri/fast-convergence/lab-03-bgp-pic-and-addpaths.unl"
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: BGP PIC and Add-Paths (EVE-NG: {host})")
    print("=" * 60)
