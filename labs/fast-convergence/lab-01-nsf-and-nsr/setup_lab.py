#!/usr/bin/env python3
"""
Lab Setup — NSF and NSR (Fast Convergence Lab 01)
...
Initial configs are the lab-00 solutions (BFD + fast timers). This lab adds
IS-IS NSF and BGP GR on top — the student configures those steps.
...
# Depth: lab-01-nsf-and-nsr/ -> fast-convergence/ -> labs/
...
DEFAULT_LAB_PATH = "ccnp-spri/fast-convergence/lab-01-nsf-and-nsr.unl"
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: NSF and NSR (EVE-NG: {host})")
    print("=" * 60)
