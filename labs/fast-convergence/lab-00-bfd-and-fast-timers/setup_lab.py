#!/usr/bin/env python3
"""
Lab Setup — BFD and Fast Timer Tuning (Fast Convergence Lab 00)
...
# Depth: lab-00-bfd-and-fast-timers/ -> fast-convergence/ -> labs/
...
# falls back to find_open_lab() and walks the folder tree. The ccnp-spri
# segment MUST match the EVE-NG parent folder for this project.
DEFAULT_LAB_PATH = "ccnp-spri/fast-convergence/lab-00-bfd-and-fast-timers.unl"
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: BFD and Fast Timer Tuning (EVE-NG: {host})")
    print("=" * 60)
