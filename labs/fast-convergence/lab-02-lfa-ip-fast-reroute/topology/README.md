# Topology — Fast Convergence Lab 02: IS-IS LFA and IP FRR

## Topology Summary

Five-router IS-IS L2 meshed core (R1–R4) with one external CE (R5 in AS 65200)
dual-homed via two eBGP links. Identical physical topology to lab-00 and lab-01.
...
3. Select the `.unl` file for this lab (`lab-02-lfa-ip-fast-reroute.unl`).
