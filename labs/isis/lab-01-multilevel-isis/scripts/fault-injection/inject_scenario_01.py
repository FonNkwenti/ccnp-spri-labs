...
FAULT_COMMANDS = [
    ...
    "net 49.0099.0000.0000.0004.00",
]

# Pre-flight: read the IS-IS process on R4 to confirm it is in the known-good state.
PREFLIGHT_CMD = "show running-config | section router isis"
# If this string is already present -> fault already injected, bail out.
PREFLIGHT_FAULT_MARKER = "49.0099.0000.0000.0004.00"
# If this string is absent -> not in solution state, bail out.
PREFLIGHT_SOLUTION_MARKER = "49.0002.0000.0000.0004.00"
