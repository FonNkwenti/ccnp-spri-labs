#!/usr/bin/env python3
"""
Lab Setup — Multilevel IS-IS and Route Advertisement (isis/lab-01)
...
Usage:
    ...
    python3 setup_lab.py --host <eve-ng-ip> --reset --node R4
...
DEFAULT_LAB_PATH = "ccnp-spri/isis/lab-01-multilevel-isis.unl"
...
def main() -> int:
    ...
    parser.add_argument("--node", default=None,
                        help="Comma-separated device names to configure (e.g., R1,R4)")
    ...
    print("=" * 60)
    print(f"Lab Setup: Multilevel IS-IS and Route Advertisement (EVE-NG: {host})")
    if args.reset:
