...
DEVICE_NAME = "R2"
FAULT_COMMANDS = [
    "no ip prefix-list LEAK_FROM_L2 seq 5 permit 192.168.66.0/24",
]

# Pre-flight: check the LEAK_FROM_L2 prefix-list to verify the permit entry is present.
PREFLIGHT_CMD = "show ip prefix-list LEAK_FROM_L2"
# If this string is absent → not in solution state, bail out.
PREFLIGHT_SOLUTION_MARKER = "seq 5 permit 192.168.66.0/24"
# If this string is present → fault already injected, bail out.
# After fault removal, the prefix-list either shows no entries or just the header.
# "ip prefix-list LEAK_FROM_L2 is not set" appears when the list is completely empty.
PREFLIGHT_FAULT_MARKER = "ip prefix-list LEAK_FROM_L2 is not set"
