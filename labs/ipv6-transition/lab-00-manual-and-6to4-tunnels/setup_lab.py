#!/usr/bin/env python3
"""
Lab Setup — Lab 00: Static IPv6-in-IPv4 and 6to4 Tunnels
...
# Depth: lab-00-manual-and-6to4-tunnels/ -> ipv6-transition/ -> labs/
...
# Fast-path lab path for resolve_and_discover. The [PROJECT_FOLDER] segment must
# match the EVE-NG parent folder name (e.g. "ccnp-spri"). If the lab is imported
# under a different folder, the helper falls back to find_open_lab().
DEFAULT_LAB_PATH = "[PROJECT_FOLDER]/ipv6-transition/lab-00-manual-and-6to4-tunnels.unl"
...
def main() -> int:
    ...
    parser.add_argument("--reset", action="store_true",
                        help="Soft-reset before configuring: clear routing and interfaces")
    args = parser.parse_args()

    host = require_host(args.host)

    print("=" * 60)
    print(f"Lab Setup: Lab 00 — Static IPv6-in-IPv4 and 6to4 Tunnels (EVE-NG: {host})")
    print("=" * 60)
