...
# Pre-flight: read running config on Tunnel1 to verify the lab is in the
# expected solution state before injecting.
PREFLIGHT_CMD = "show running-config interface Tunnel1"
# If this string is already present → fault already injected, bail out.
PREFLIGHT_FAULT_MARKER = "tunnel mode gre ip"
# If this string is absent → not in solution state, bail out.
PREFLIGHT_SOLUTION_MARKER = "tunnel mode ipv6ip 6to4"
