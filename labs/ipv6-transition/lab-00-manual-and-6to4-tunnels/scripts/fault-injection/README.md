# Fault Injection — IPv6-Transition Lab 00
...
| Scenario | Inject Command | Affected Device | Workbook Ticket |
|----------|---------------|-----------------|-----------------|
| 01 | `python3 inject_scenario_01.py --host <eve-ng-ip>` | R4 | Ticket 1 |
| 02 | `python3 inject_scenario_02.py --host <eve-ng-ip>` | R1 | Ticket 2 |
| 03 | `python3 inject_scenario_03.py --host <eve-ng-ip>` | R1 | Ticket 3 |
