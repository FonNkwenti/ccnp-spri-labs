#!/usr/bin/env python3
"""
Lab Setup — SRv6 IS-IS Control Plane (SRv6 Lab 00)
...
# Depth: lab-00-srv6-control-plane/ -> srv6/ -> labs/
...
DEFAULT_LAB_PATH = "ccnp-spri/srv6/lab-00-srv6-control-plane.unl"
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: SRv6 IS-IS Control Plane (EVE-NG: {host})")
