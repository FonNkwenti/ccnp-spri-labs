...
# Pre-flight: verify RSVP bandwidth on the target interface before injecting.
PREFLIGHT_CMD = "show running-config interface GigabitEthernet0/2"
# If this string is already present -> fault already injected (bandwidth already reduced).
PREFLIGHT_FAULT_MARKER = "ip rsvp bandwidth 10 10"
# If this string is absent -> not in solution state, bail out.
PREFLIGHT_SOLUTION_MARKER = "ip rsvp bandwidth 100000 100000"
