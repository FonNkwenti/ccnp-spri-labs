#!/usr/bin/env python3
"""
Lab Setup — MPLS Capstone I (MPLS Lab 04)
...
# Depth: lab-04-capstone-config/ -> mpls/ -> labs/
...
DEFAULT_LAB_PATH = "ccnp-spri/mpls/lab-04-capstone-config.unl"
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: MPLS Capstone I (EVE-NG: {host})")
    print("=" * 60)
