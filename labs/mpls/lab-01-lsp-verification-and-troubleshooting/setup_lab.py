#!/usr/bin/env python3
"""
Lab Setup — MPLS Lab 01: LSP Verification with MPLS OAM
...
DEFAULT_LAB_PATH = "ccnp-spri/mpls/lab-01-lsp-verification-and-troubleshooting.unl"
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: MPLS Lab 01 — LSP Verification (EVE-NG: {host})")
    print("=" * 60)
