#!/usr/bin/env python3
"""
Solution Restoration — MPLS Lab 02: BGP-Free Core and Unified BGP (Labeled Unicast)
...
Usage:
    ...
    python3 apply_solution.py --host <eve-ng-ip> --node PE1       # restore one device
    python3 apply_solution.py --host <eve-ng-ip> --reset --node P1  # soft-reset + restore one device
...
# Scenario 01: PE1, PE2 (next-hop-self removed from both)
# Scenario 02: P1 (BGP process added)
# Scenario 03: PE2 (send-label removed)
RESTORE_TARGETS = [
    "PE1",
    "PE2",
    "P1",
...
def main() -> int:
    ...
    parser.add_argument("--node", default=None,
                        help="Restore a single device only (e.g. PE1). Omit to restore all targets.")
