...
# Pre-flight: confirm P1 has no BGP process (solution state)
PREFLIGHT_CMD = "show ip bgp summary"
# Solution state: BGP is not active on P1
PREFLIGHT_SOLUTION_MARKER = "BGP not active"
# Fault state: BGP process exists on P1
PREFLIGHT_FAULT_MARKER = "local AS number 65100"
