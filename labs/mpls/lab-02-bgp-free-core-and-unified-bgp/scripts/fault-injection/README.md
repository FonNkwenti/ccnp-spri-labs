# Fault Injection — MPLS Lab 02: BGP-Free Core and Unified BGP
...
python3 apply_solution.py --host <eve-ng-ip> --node PE1

# Soft-reset + restore a single device
python3 apply_solution.py --host <eve-ng-ip> --reset --node PE1
```

## Available Scenarios

### Ticket 1
- **Devices targeted:** PE1, PE2
