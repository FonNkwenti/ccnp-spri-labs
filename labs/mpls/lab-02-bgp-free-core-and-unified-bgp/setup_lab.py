#!/usr/bin/env python3
"""
Lab Setup — MPLS Lab 02: BGP-Free Core and Unified BGP (Labeled Unicast)
...
DEFAULT_LAB_PATH = "ccnp-spri/mpls/lab-02-bgp-free-core-and-unified-bgp.unl"
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: MPLS Lab 02 — BGP-Free Core (EVE-NG: {host})")
    print("=" * 60)
