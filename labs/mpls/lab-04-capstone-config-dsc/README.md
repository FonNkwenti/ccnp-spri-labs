# MPLS Lab 04: Full Mastery — Capstone I (DSC)
...
This variant (DSC, deepseek-v4-pro) was built with `--force-model` override.
...
python3 labs/mpls/lab-04-capstone-config-dsc/setup_lab.py --host <eve-ng-ip>

# 4. Open the workbook and start with Task 1
open labs/mpls/lab-04-capstone-config-dsc/workbook.md
```

## Files

```
lab-04-capstone-config-dsc/
