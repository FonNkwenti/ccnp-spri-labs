#!/usr/bin/env python3
"""
Lab Setup — MPLS Capstone I (MPLS Lab 04, DSC)

Pushes IP-only initial configs to all lab devices via EVE-NG console ports.
This is a clean_slate capstone — only addressing is pre-loaded; the student
configures every protocol layer (IS-IS, LDP, iBGP+LU, eBGP, MPLS-TE, Tunnel10).
...
# Depth: lab-04-capstone-config-dsc/ -> mpls/ -> labs/
...
DEFAULT_LAB_PATH = "ccnp-spri/mpls/lab-04-capstone-config-dsc.unl"
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: MPLS Capstone I (DSC) — EVE-NG: {host}")
    print("=" * 60)
