...
# Running-config check: 'mpls ip' present = good state; absent = fault active
PREFLIGHT_CMD = "show running-config interface GigabitEthernet0/2"
PREFLIGHT_SOLUTION_MARKER = "mpls ip"
# IOS does not store 'no mpls ip' explicitly; rely on SOLUTION_MARKER absence
PREFLIGHT_FAULT_MARKER = "__FAULT_ALREADY_ACTIVE__"
