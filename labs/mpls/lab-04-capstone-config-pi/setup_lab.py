#!/usr/bin/env python3
"""
Lab Setup — MPLS Full Mastery Capstone I (Lab 04)

Pushes initial configs to all six lab devices via EVE-NG console ports.
...
# Depth: lab-04-capstone-config-pi/ -> mpls/ -> labs/
...
DEFAULT_LAB_PATH = "ccnp-spri/mpls/lab-04-capstone-config-pi.unl"
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: MPLS Full Mastery Capstone I (EVE-NG: {host})")
    print("=" * 60)
