#!/usr/bin/env python3
"""
Lab Setup — RSVP-TE Tunnels with Explicit Paths (MPLS Lab 03)
...
# Depth: lab-03-rsvp-te-tunnels/ -> mpls/ -> labs/
...
DEFAULT_LAB_PATH = "ccnp-spri/mpls/lab-03-rsvp-te-tunnels.unl"
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: RSVP-TE Tunnels with Explicit Paths (EVE-NG: {host})")
    print("=" * 60)
