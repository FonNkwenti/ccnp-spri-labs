# Topology — MPLS Lab 03: RSVP-TE Tunnels with Explicit Paths
...
links (L1–L7). All core links run IS-IS L2, MPLS LDP, and RSVP-TE; CE–PE links are plain IP for
eBGP. PE1 is the RSVP-TE headend; PE2 is the tail. P1 and P2 are BGP-free transit nodes.
