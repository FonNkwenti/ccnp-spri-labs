#!/usr/bin/env python3
"""
Solution Restoration — MPLS Lab 03: RSVP-TE Tunnels with Explicit Paths
...
Usage:
    ...
    python3 apply_solution.py --host <eve-ng-ip> --node P1        # restore one device
    python3 apply_solution.py --host <eve-ng-ip> --reset --node P2  # soft-reset + restore one device
...
# All devices touched by any of the three troubleshooting scenarios.
# Scenario 01: PE1 (RSVP bandwidth on Gi0/2)
# Scenario 02: P2 (IS-IS TE extensions)
# Scenario 03: P1 (global mpls traffic-eng tunnels)
RESTORE_TARGETS = [
    "PE1",
    "P1",
    "P2",
...
def main() -> int:
    ...
    parser.add_argument("--node", default=None,
                        help="Restore a single device only (e.g. P1). Omit to restore all targets.")
