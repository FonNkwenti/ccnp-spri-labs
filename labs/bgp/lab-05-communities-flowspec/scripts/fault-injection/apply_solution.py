#!/usr/bin/env python3
"""
Solution Restoration -- Lab 05: BGP Communities and FlowSpec
...
Usage:
    ...
    python3 apply_solution.py --host <eve-ng-ip> --reset --node R6  # soft-reset + restore one device
...
DEFAULT_LAB_PATH = "ccnp-spri/bgp/lab-05-communities-flowspec.unl"

# All devices touched by any scenario -- restored in order.
# Scenario 01 touches R4; Scenario 02 touches R5; Scenario 03 touches R6.
# All seven devices included so a full domain restore returns every router to known-good state.
RESTORE_TARGETS = [
    "R1",
    "R2",
    "R3",
