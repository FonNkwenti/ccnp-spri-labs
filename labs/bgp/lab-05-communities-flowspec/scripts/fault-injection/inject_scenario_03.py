...
FAULT_COMMANDS = [
    "router bgp 65002",
    "address-family ipv4",
    "no neighbor 10.1.56.5 send-community",
    "exit-address-family",
]

# Pre-flight: verify R6 has send-community toward R5 before injecting.
...
PREFLIGHT_SOLUTION_MARKER = "neighbor 10.1.56.5 send-community"
