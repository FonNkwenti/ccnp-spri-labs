#!/usr/bin/env python3
"""
Lab Setup — BGP Lab 02: eBGP Multihoming and Traffic Engineering
...
# Depth: lab-02-ebgp-multihoming/ -> bgp/ -> labs/
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: BGP Lab 02 — eBGP Multihoming (EVE-NG: {host})")
    print("=" * 60)
