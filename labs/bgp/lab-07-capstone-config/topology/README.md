# Lab 07: Full Protocol Mastery — Topology

## Summary

Three-AS service-provider topology with a 7th external peer for FlowSpec. **AS 65100**
is the SP core (R2/R3/R4/R5) running OSPF area 0 + iBGP via R4 as Route Reflector.
**AS 65001** is dual-homed Customer A (R1). **AS 65002** is an external SP peer (R6).
**AS 65003** is the FlowSpec originator (R7).
...
4. Push the clean-slate baseline:
   ```bash
