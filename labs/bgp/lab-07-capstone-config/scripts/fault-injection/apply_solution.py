#!/usr/bin/env python3
"""
Solution Restoration -- Lab 07: BGP Capstone Configuration
...
# Scenario 01 touches R4; Scenario 02 touches R2; Scenario 03 touches R5.
# All seven devices included so a full domain restore returns every router to known-good.
RESTORE_TARGETS = [
    "R1",
    "R2",
    "R3",
