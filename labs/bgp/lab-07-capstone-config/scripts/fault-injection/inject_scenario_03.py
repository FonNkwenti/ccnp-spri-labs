...
FAULT_COMMANDS = [
    "router bgp 65100",
    "address-family ipv4",
    "no neighbor 10.1.57.7 maximum-prefix 100 75 restart 5",
    "neighbor 10.1.57.7 maximum-prefix 1 75 restart 1",
    "exit-address-family",
]

PREFLIGHT_CMD = "show running-config | section router bgp"
PREFLIGHT_SOLUTION_MARKER = "neighbor 10.1.57.7 maximum-prefix 100 75 restart 5"
PREFLIGHT_FAULT_MARKER = "neighbor 10.1.57.7 maximum-prefix 1 75 restart 1"
...
def main() -> int:
    ...
    print("=" * 60)
    print("Fault Injection: Scenario 03 -- R5-R7 Session Flaps (max-prefix)")
    print("=" * 60)
