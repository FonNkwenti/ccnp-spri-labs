#!/usr/bin/env python3
"""
Lab Setup - BGP Lab 07: Full Protocol Mastery (Capstone I)

Pushes the clean-slate (interface-only) initial configs to all 7 lab devices via
EVE-NG console ports. Ports are discovered at runtime via the EVE-NG REST API.
...
DEFAULT_LAB_PATH = "ccnp-spri/bgp/lab-07-capstone-config.unl"
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: BGP Lab 07 - Capstone I (EVE-NG: {host})")
    print("=" * 60)
