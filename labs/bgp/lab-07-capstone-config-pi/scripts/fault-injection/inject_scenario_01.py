...
FAULT_COMMANDS = [
    "router bgp 65100",
    "address-family ipv4",
    "no neighbor 10.0.0.5 route-reflector-client",
]

# Pre-flight: verify R5 is an RR client on R4.
PREFLIGHT_CMD = "show ip bgp neighbors 10.0.0.5 | include route-reflector"
# If this string is already present → fault already injected, bail out.
PREFLIGHT_FAULT_MARKER = "RR_CLIENT_FAULT_89A2F1C4_INJECTED"
# If this string is absent → not in solution state, bail out.
PREFLIGHT_SOLUTION_MARKER = "route-reflector"
