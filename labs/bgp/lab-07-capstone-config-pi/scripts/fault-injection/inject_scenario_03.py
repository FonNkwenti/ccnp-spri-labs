...
FAULT_COMMANDS = [
    "router bgp 65100",
    "address-family ipv4",
    "no neighbor 10.0.0.4 send-community",
]

# Pre-flight: verify send-community is configured on R2 toward R4.
PREFLIGHT_CMD = "show ip bgp neighbors 10.0.0.4 | include Community"
# If this string is already present → fault already injected, bail out.
PREFLIGHT_FAULT_MARKER = "SEND_COMM_FAULT_89A2F1C4_INJECTED"
# If this string is absent → not in solution state, bail out.
PREFLIGHT_SOLUTION_MARKER = "Community attribute"
