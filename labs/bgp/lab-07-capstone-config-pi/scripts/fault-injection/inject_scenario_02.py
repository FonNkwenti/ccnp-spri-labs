...
# Pre-flight: verify the route-map is applied inbound on R2 toward R1.
PREFLIGHT_CMD = "show ip bgp neighbors 10.1.12.1 | include route-map"
# If this string is already present → fault already injected, bail out.
PREFLIGHT_FAULT_MARKER = "ROUTE_MAP_FAULT_89A2F1C4_INJECTED"
# If this string is absent → not in solution state, bail out.
PREFLIGHT_SOLUTION_MARKER = "FROM-CUST-A-PRIMARY"
