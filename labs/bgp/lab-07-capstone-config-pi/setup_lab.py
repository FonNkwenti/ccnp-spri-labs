#!/usr/bin/env python3
"""
Lab Setup — BGP Full Protocol Mastery Capstone I (Lab 07)

Pushes initial configs to all seven lab devices via EVE-NG console ports.
...
# Depth: lab-07-capstone-config-pi/ -> bgp/ -> labs/
...
DEFAULT_LAB_PATH = "ccnp-spri/bgp/lab-07-capstone-config-pi.unl"
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: BGP Full Protocol Mastery Capstone I (EVE-NG: {host})")
    print("=" * 60)
