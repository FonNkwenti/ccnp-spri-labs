#!/usr/bin/env python3
"""
Solution Restoration -- Lab 00: eBGP and iBGP Foundations
...
DEFAULT_LAB_PATH = "ccnp-spri/bgp/lab-00-ebgp-ibgp-foundations.unl"

# All devices affected by the troubleshooting scenarios -- restored in order.
# Scenarios 01 and 03 target R2; Scenario 02 targets R5.
# Full domain restore included for completeness.
RESTORE_TARGETS = [
    "R1",
    "R2",
    "R3",
