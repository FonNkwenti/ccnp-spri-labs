...
FAULT_COMMANDS = [
    ...
    "neighbor 10.1.12.1 remote-as 65999",
]
...
PREFLIGHT_FAULT_MARKER = "neighbor 10.1.12.1 remote-as 65999"
# If this string is absent -> not in solution state, bail out.
PREFLIGHT_SOLUTION_MARKER = "neighbor 10.1.12.1 remote-as 65001"
...
def main() -> int:
    ...
    print("=" * 60)
    print("Fault Injection: Scenario 03 -- R1 eBGP Session to R2 Stays in Active")
    print("=" * 60)
