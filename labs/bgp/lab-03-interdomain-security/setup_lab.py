#!/usr/bin/env python3
"""
Lab Setup — BGP Lab 03: Inter-Domain Security and Maximum-Prefix
...
# Depth: lab-03-interdomain-security/ -> bgp/ -> labs/
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: BGP Lab 03 — Inter-Domain Security (EVE-NG: {host})")
    print("=" * 60)
