#!/usr/bin/env python3
"""
Solution Restoration -- Lab 03: Inter-Domain Security and Maximum-Prefix
...
DEFAULT_LAB_PATH = "ccnp-spri/bgp/lab-03-interdomain-security.unl"

# All devices affected by the troubleshooting scenarios -- restored in order.
# Scenario 01 targets R1, Scenario 02 targets R6, Scenario 03 targets R1.
# All six devices included for a full domain restore.
RESTORE_TARGETS = [
    "R1",
    "R2",
    "R3",
