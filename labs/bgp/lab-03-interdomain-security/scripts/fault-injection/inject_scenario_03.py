...
# Pre-flight: check R1's BGP address-family to verify known-good state.
PREFLIGHT_CMD = "show running-config | section router bgp"
# If this string is already present -> fault already injected, bail out.
PREFLIGHT_FAULT_MARKER = "redistribute connected"
# If this string is absent -> not in solution state, bail out.
PREFLIGHT_SOLUTION_MARKER = "network 172.16.1.0 mask 255.255.255.0"
