#!/usr/bin/env python3
"""
Solution Restoration -- Lab 04: BGP Route Dampening and Dynamic Neighbors
...
DEFAULT_LAB_PATH = "ccnp-spri/bgp/lab-04-dampening-dynamic.unl"

# All devices in the lab -- restored in order.
# Scenario 01 touches R6 (flap source); Scenarios 02 and 03 touch R2.
# All six devices included so a full domain restore returns every router to known-good state.
RESTORE_TARGETS = [
    "R1",
    "R2",
    "R3",
