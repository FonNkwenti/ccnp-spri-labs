#!/usr/bin/env python3
"""
Lab Setup — BGP Lab 04: Route Dampening and Dynamic Neighbors
...
# Depth: lab-04-dampening-dynamic/ -> bgp/ -> labs/
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: BGP Lab 04 — Route Dampening and Dynamic Neighbors (EVE-NG: {host})")
    print("=" * 60)
