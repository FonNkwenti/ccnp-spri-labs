#!/usr/bin/env python3
"""
Lab Setup — OSPF Lab 05: OSPF Comprehensive Troubleshooting — Capstone II

Pushes pre-broken initial configs to all lab devices via EVE-NG console ports.
Ports are discovered at runtime via the EVE-NG REST API — no hardcoded ports needed.

This is a troubleshooting capstone. Initial configs contain 5 concurrent faults.
Students diagnose and repair them. Use scripts/fault-injection/apply_solution.py
to restore the known-good state after the exercise.
...
# Depth: lab-05-capstone-troubleshooting/ -> ospf/ -> labs/
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: OSPF Lab 05 — Capstone II (EVE-NG: {host})")
    print("NOTE: This topology contains 5 pre-planted faults.")
    if args.reset:
