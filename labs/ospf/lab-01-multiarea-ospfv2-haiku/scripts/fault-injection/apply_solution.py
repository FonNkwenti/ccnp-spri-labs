#!/usr/bin/env python3
"""
Solution Restoration — OSPF Lab 01: Multiarea OSPFv2 and LSA Propagation
...
Use --reset for Scenario 02: the prefix-list and area filter-list added by
inject_scenario_02.py cannot be removed by config push alone; --reset performs
a write-erase before restoring so those entries are cleanly eliminated.
...
# Scenario 02: R2 (outbound Type-3 filter)
# Scenario 03: R3 (area mismatch on Gi0/2)
RESTORE_TARGETS = [
    "R2",
    "R3",
]
...
def main() -> int:
    ...
    parser.add_argument("--reset", action="store_true",
                        help="Erase device config before restoring (required for Scenario 02)")
