#!/usr/bin/env python3
"""
Lab Setup — OSPF Lab 03: Summarization, Stub, and NSSA
...
# Depth: lab-03-summarization-stub-nssa/ -> ospf/ -> labs/
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: OSPF Lab 03 — Summarization, Stub, and NSSA (EVE-NG: {host})")
    if args.reset:
