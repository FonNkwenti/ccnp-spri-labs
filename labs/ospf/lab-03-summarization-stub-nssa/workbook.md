...
| **R1** | Loopback2 | 172.16.2.1 | 2001:db8:2::1 | /24 / /64 | 1 | Test stub prefix (summarization) |
| **R1** | Loopback3 | 172.16.3.1 | 2001:db8:3::1 | /24 / /64 | 1 | Test stub prefix (summarization) |
