# Fault Injection — OSPF Lab 00: Single-Area OSPFv2
...
Use `--reset` after Scenario 02 to ensure no stale OSPF process configuration
remains from the fault. Safe to run after any scenario.
