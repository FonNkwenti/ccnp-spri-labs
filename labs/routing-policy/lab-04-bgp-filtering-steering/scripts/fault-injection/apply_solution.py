#!/usr/bin/env python3
"""
Solution Restoration -- BGP Filtering and Steering Lab (lab-04-bgp-filtering-steering)
...
Usage:
    ...
    python3 apply_solution.py --host <eve-ng-ip> --reset --node R3  # soft-reset + restore one IOS device
...
# Depth: scripts/fault-injection -> scripts -> lab-04-bgp-filtering-steering -> routing-policy -> labs/
...
# All devices in this lab -- restored in order.
