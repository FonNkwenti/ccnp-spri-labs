#!/usr/bin/env python3
"""
Solution Restoration -- Routing Policy Lab 00: Route-Maps Foundations
...
# All devices in this lab. All three scenarios target R1 only, but the full
# device set is included so a single restore call returns the whole domain
# to known-good state.
RESTORE_TARGETS = [
    "R1",
    "R2",
