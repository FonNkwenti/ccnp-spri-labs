...
# Pre-flight: check the current P_CUSTOMER prefix-set definition.
PREFLIGHT_CMD = "show rpl prefix-set P_CUSTOMER"
# If this string is already present -> fault already injected, bail out.
PREFLIGHT_FAULT_MARKER = "172.0.0.0/8 le 24"
# If this string is absent -> not in solution state, bail out.
PREFLIGHT_SOLUTION_MARKER = "172.16.0.0/16 le 24"
