# Fault Injection — Multicast Lab 00: PIM-SM Foundations
...
| Script | Ticket | Target |
|--------|--------|--------|
| inject_scenario_01.py | Ticket 1 | R1 |
| inject_scenario_02.py | Ticket 2 | R4 |
| inject_scenario_03.py | Ticket 3 | R2 |
