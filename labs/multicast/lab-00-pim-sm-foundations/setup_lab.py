...
running this script. SRC1 and RCV1 are Linux VMs configured manually — see Task 4
in workbook.md.
"""
...
# Depth: lab-00-pim-sm-foundations/ -> multicast/ -> labs/
...
DEFAULT_LAB_PATH = "ccnp-spri/multicast/lab-00-pim-sm-foundations.unl"

# Routers only — SRC1 and RCV1 are Linux VMs configured manually per Task 4.
DEVICES = [
    "R1",
    "R2",
    "R3",
...
def main() -> int:
    ...
    print("=" * 60)
    print(f"Lab Setup: PIM-SM Foundations (EVE-NG: {host})")
    print("=" * 60)
